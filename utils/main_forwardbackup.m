...
plot(trainx,p3.forward(trainx),'*m','MarkerEdgeColor','m','MarkerFaceColor','m','MarkerSize',4);
hold on
%plot(testx,testy,'+b','MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',4);
plot(testx,p3.forward(testx),'*c','MarkerEdgeColor','c','MarkerFaceColor','c','MarkerSize',4);
...
plot(testx,p3.forward(testx),'+r','MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',4);

hold on

plot(testx,p4.forward(testx),'*k','MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',4);

plot(testx,p5.forward(testx),'xc','MarkerEdgeColor','c','MarkerFaceColor','c','MarkerSize',4);

plot(testx,p6.forward(testx),'*m','MarkerEdgeColor','m','MarkerFaceColor','m','MarkerSize',4);
...
plot(testx,p3.forward(testx),'+r','MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',4);
hold on
plot(testx,p5.forward(testx),'xk','MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',4);
plot(testx,p6.forward(testx),'*m','MarkerEdgeColor','m','MarkerFaceColor','m','MarkerSize',4);
